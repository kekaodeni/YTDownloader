...
- Default branch: `main`
- Current main: latest `origin/main` at audit time (the release package was built from the preceding verified source commit `641dfcb1f6ea19d6ad8cc58eeb05943dd531b330`)
