...
_ALLOWED: dict[TaskStatus, set[TaskStatus]] = {
    TaskStatus.PENDING: {TaskStatus.FETCHING_METADATA, TaskStatus.DOWNLOADING_VIDEO, TaskStatus.FAILED, TaskStatus.CANCELLING},
    TaskStatus.FETCHING_METADATA: {TaskStatus.READY, TaskStatus.FAILED, TaskStatus.CANCELLING},
    TaskStatus.READY: {TaskStatus.PENDING, TaskStatus.DOWNLOADING_VIDEO, TaskStatus.FAILED, TaskStatus.CANCELLING},
    TaskStatus.DOWNLOADING_VIDEO: {
        TaskStatus.DOWNLOADING_AUDIO, TaskStatus.MERGING, TaskStatus.POST_PROCESSING,
        TaskStatus.COMPLETED, TaskStatus.FAILED, TaskStatus.CANCELLING,
    },
    TaskStatus.DOWNLOADING_AUDIO: {
        TaskStatus.MERGING, TaskStatus.POST_PROCESSING, TaskStatus.COMPLETED,
        TaskStatus.FAILED, TaskStatus.CANCELLING,
    },
    TaskStatus.MERGING: {TaskStatus.POST_PROCESSING, TaskStatus.COMPLETED, TaskStatus.FAILED, TaskStatus.CANCELLING},
    TaskStatus.POST_PROCESSING: {TaskStatus.COMPLETED, TaskStatus.FAILED, TaskStatus.CANCELLING},
